function () {
    var patient = this;
    var measure = patient.measures["0111"];
    if (measure == null) {
        measure = {};
    } <%= init_js_frameworks %>
    ...
    var numerator = function () {
            ...
            var assessment_after_diagnosis_before_treatment = sortedSomethingsInRange(measure.procedure_bh_assessment_for_suicidality_procedure_performed, index_encounter, index_earliest_treatment + 1 * day);
