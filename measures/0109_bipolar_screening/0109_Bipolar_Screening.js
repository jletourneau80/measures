function () {
    var patient = this;
    var measure = patient.measures["0109"];
    if (measure == null) {
        measure = {};
    } <%= init_js_frameworks %>
    ...
    var denominator = function () {
            ...
            var diagnoses = normalize(measure.condition_bh_conditions_involving_unipolar_depression_diagnosis_active);
            ...
            var treatments = normalize(
            	measure.procedure_bh_psychotherapy_procedure_performed, 
				measure.procedure_bh_psychotherapy_procedure_ordered, 
				measure.procedure_bh_counseling_for_depression_procedure_performed, 
				measure.procedure_bh_counseling_for_depression_procedure_ordered, 
				measure.procedure_bh_electroconvulsive_therapy_procedure_performed, 
				measure.procedure_bh_electroconvulsive_therapy_procedure_ordered, 
            ...
            var meds_active = normalize(measure.anti_depressant_medication_medication_active);
    ...
    var numerator = function () {
            ...
            var assessment_after_diagnosis_before_treatment = sortedSomethingsInRange(measure.procedure_bh_assessment_of_patients_with_depression_for_bipolar_disorder_procedure_performed, index_encounter, index_earliest_treatment + 1 * day);
